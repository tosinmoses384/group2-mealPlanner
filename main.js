...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
const airtable_write_endpoint =
  "https://api.airtable.com/v0/apphTiD0fBP6jaEOT/mealTable?api_key=key2VElMJ7JqvoQDi";
const airtable_read_endpoint =
  "https://api.airtable.com/v0/apphTiD0fBP6jaEOT/mealTable?api_key=key2VElMJ7JqvoQDi&sort%5B0%5D%5Bfield%5D=Cook%20When&%20sort%5B0%5D%5Bdirection%5D=desc";

// %%%%%%%%%%%%%%%%%%%%%%%%%%
// POST TO AIRTABLE DATABASE
// %%%%%%%%%%%%%%%%%%%%%%%%
...
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
// LOADS ALL MEALS FROM THE DATABASE AS THE PAGE IS LOADING
// %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function showMeals() {
  axios
